...
<form action="" autocomplete="off" method="POST">
		<table border="1" size="50" class="table-login" style="text-align: center;border-collapse: collapse;">
			<tr>
			...
			<tr>
				<td>Mật khẩu cũ</td>
				<td><input type="text" name="password_cu" size="50"></td>
			</tr>
			<tr>
				<td>Mật khẩu mới</td>
				<td><input type="text" name="password_moi" size="50"></td>
			</tr>
			<tr>
